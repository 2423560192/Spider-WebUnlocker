...
def get_resp(page):
    ...
    cookies = {
        ...
        "Hm_lvt_c99546cf032aaa5a679230de9a95c7db": "1746776721,1746846259,1746860209,1746876536",
        "HMACCOUNT": "D8E43A19B6731930",
        "qpfccr": "true",
        "no-alert3": "true",
        "Hm_lvt_9bcbda9cbf86757998a2339a0437208e": "1746776739,1746846273,1746860215,1746876543",
        "Hm_lpvt_9bcbda9cbf86757998a2339a0437208e": "1746876543",
        "Hm_lpvt_c99546cf032aaa5a679230de9a95c7db": "1746880868"
    }
    ...
    with httpx.Client(http2=True, cookies=cookies, headers=headers) as client:
        response = client.get('https://match.yuanrenxue.cn/api/match/16', params=params)
