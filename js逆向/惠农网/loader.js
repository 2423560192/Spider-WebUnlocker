...
function get_sign() {
    ...
    "deviceId": "4ce435c-9b08-44a3-8224-afb833f64",
    "secret": "EOi^0N5sWWHhkrF2A0gekY9U20BgnAcr",
    "secretType": 2
}
    console.log(K)
    headers = {
    'x-client-id': K['deviceId'],
    'x-client-nonce': K['nonce'],
    'x-client-page': '/',
    'x-client-sid': 'S_0M5S9KIULFK7ZC7U',
    'x-client-sign': '',
    'x-client-time': K["timestamp"],
    ...
    L = CryptoJS.MD5(m)['toString']()
    console.log('L:::', L)

    y = j

    B = CryptoJS.SHA1(y)['toString']()
    console.log("B:::", B)

    _ = T
    M = R
    N = CryptoJS.MD5(M + _)['toString']()
    console.log("N:::", N)
    ...
    console.log("F:::", F)
    x_sign = CryptoJS.SHA384(F)['toString']()

    headers['x-client-sign'] = x_sign
    return headers
}
