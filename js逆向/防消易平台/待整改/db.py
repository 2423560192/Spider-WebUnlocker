...
class DB:
    def __init__(self):
        ...
        self.pooldb = PooledDB(
            ...
            mincached=30,  # 初始化时，链接池中至少创建的空闲的链接，0表示不创建
            maxcached=60,  # 链接池中最多闲置的链接，0和None不限制
    ...
    def create_table(self):
        try:
            create_subsidy_table_query = '''
                CREATE TABLE IF NOT EXISTS subsidy_info4 (
    ...
    def search(self):
        insert_query = '''
          SELECT creditCode FROM subsidy_info4;
        '''
