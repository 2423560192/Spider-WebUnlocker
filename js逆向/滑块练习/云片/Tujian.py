...
if __name__ == "__main__":
    img_path = "D:\projects\Spider-WebUnlocker\js逆向\滑块练习\腾讯滑块\cap_union_new_getcapbysig.png"
    result = base64_api(uname='jiaoxingk', pwd='Cs5201314dd', img=img_path, typeid=33)
    print(result)
