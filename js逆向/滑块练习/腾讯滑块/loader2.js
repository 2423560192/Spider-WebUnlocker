...
function get_ans(t, e) {
    for (var r = t.nonce, n = t.target, i = +new Date, o = 0, a = "number" == typeof e ? e : 3e4; g("".concat(r).concat(o)) !== n && (o += 1,
        !(+new Date - i > a));)
        ;
    return {
        ans: o,
...
t = {
    "target": "191729c47dd5fc8cafcd24ebf230f543",
    "nonce": "3fce13c8e5b56ba#"
}
console.log(get_ans(t));