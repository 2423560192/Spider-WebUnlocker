...
headers = {
    ...
    'pragma': 'no-cache',
    'priority': 'u=1, i',
    'referer': 'https://www.baike.com/task_center/fullUpdateTask?subPage=full_create',
...
params = {
    ...
    # 'a_bogus': 'YXsO6Og2Msm1kGtRMhkz9Hx4ahW0YW5UgZENXDXdcULg',
}
...
response = requests.post(
    'https://www.baike.com/api/v2/task_center/queryDocFullUpdateTask',
    params=params,
    cookies=cookies,
    headers=headers,
    json=json_data,
