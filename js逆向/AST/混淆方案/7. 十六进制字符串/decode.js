...
(function (myArr, num) {
    ...
    var xiaojianbang = function (nums) {
        while (--nums) {
            myArr["\x70\x75\x73\x68"](myArr["\x73\x68\x69\x66\x74"]()); // 把数组第一个元素移到末尾
        }
    };
...
window[atob(arry[0])][atob(arry[1])][atob(arry[2])] = function (formatStr) {
    ...
    str = str[atob(arry[10])](/MM/, this[atob(arry[12])]() + (672246 ^ 672247) > (690478 ^ 690471) ? (this[atob(arry[12])]() + (517363 ^ 517362))[atob(arry[13])]() : atob(arry[14]) + (this[atob(arry[12])]() + (564175 ^ 564174)));
    str = str[atob(arry[10])](/dd|DD/, this[atob(arry[15])]() > (503351 ^ 503358) ? this[atob(arry[15])]()[atob(arry[13])]() : atob(arry[14]) + this[atob(arry[15])]());
    return str;
};
